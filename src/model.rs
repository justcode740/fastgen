...
pub trait Model<D: DataSet> {
    ...
    // TODO
    fn fit(x: DenseMatrix<D::Input>, y: Vec<D::Input>) -> Result<LinearRegression<f32, DenseMatrix<f32>>, String>;
...
{
    fn fit(x: DenseMatrix<D::Input>, y: Vec<D::Output>) -> Result<LinearRegression<f32, DenseMatrix<f32>>, String> {
